...
import { z } from 'zod';
export const AwgTimerSchema = z.string();
export type AwgTimer = z.infer<typeof AwgTimerSchema>;

export const GeoKindSchema = z.string();
export type GeoKind = z.infer<typeof GeoKindSchema>;

export const KeepAliveValueSchema = z.string();
export type KeepAliveValue = z.infer<typeof KeepAliveValueSchema>;
...
export const ClientSchema = z.object({
  ...
  keepAlive: z.lazy(() => KeepAliveValueSchema).optional(),
...
export const ClientRecordSchema = z.object({
  ...
  group: z.string(),
  id: z.number().int(),
  keepAlive: z.lazy(() => KeepAliveValueSchema),
...
export const HostStatusSchema = z.object({
  ifnames: z.array(z.string()).optional(),
...
export const InboundSchema = z.object({
  ...
  port: z.number().int().min(0).max(65535),
  protocol: z.enum(['vmess', 'vless', 'trojan', 'shadowsocks', 'wireguard', 'hysteria', 'http', 'mixed', 'tunnel', 'tun', 'mtproto', 'amneziawg', 'tuic', 'awg', 'naive', 'olcrtc', 'qwdtt', 'csqtt', 'mieru', 'trusttunnel', 'anytls', 'tproxy', 'cover', 'gateway']),
  remark: z.string(),
  settings: z.unknown(),
  shareAddr: z.string(),
