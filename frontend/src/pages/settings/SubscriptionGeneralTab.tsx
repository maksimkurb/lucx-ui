      ...
      items={[
        {
          ...
          children: (
            <>
              ...
              <SettingListItem
                paddings="small"
                title={t('pages.settings.subAwgEnableTitle')}
                description={t('pages.settings.subAwgEnableDesc')}
              >
                <Switch
                  checked={allSetting.subAwgEnable}
                  onChange={(v) => updateSetting({ subAwgEnable: v })}
                />
              </SettingListItem>
